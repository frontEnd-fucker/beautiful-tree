...
import { RxAvatar, RxChevronDown } from 'react-icons/rx';
...
const Avatar = ({
  ...
  size = "md",
  alt,
  placeholder = /*#__PURE__*/React.createElement(RxAvatar, null)
}) => {
...
const Collapse = ({
  ...
  const [height, setHeight] = useState(isOpen ? getElementHeight(ref) : COLLAPSED_HEIGHT);
  useLayoutEffect(() => {
    if (isOpen) {
      /**
...
const AccordionControl = ({
  ...
  }), /*#__PURE__*/React.createElement("div", Object.assign({}, stylex.props(styles.arrowBase, isActive && styles.arrowRotate)), /*#__PURE__*/React.createElement(RxChevronDown, {
    size: 16
  })), children);
};
...
export { Accordion, Avatar, Button, Collapse };
